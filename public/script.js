...
;// CONCATENATED MODULE: ./src/images/sprite.svg

    /* harmony default export */ const sprite = ((function() {
      var tempNode = document.createElement('div');
      tempNode.innerHTML = '<svg aria-hidden="true" style="position:absolute;width:0;height:0" xmlns="http://www.w3.org/2000/svg" overflow="hidden"><defs><symbol id="moon" viewBox="0 0 32 32"><path fill="currentColor" d="M17.701 32a15.97 15.97 0 0012.429-5.925c.442-.544-.04-1.339-.723-1.209-7.763 1.478-14.891-4.474-14.891-12.31 0-4.514 2.416-8.665 6.344-10.9.605-.345.453-1.262-.235-1.389-.879-.17-1.89-.267-2.923-.268-8.832 0-16 7.157-16 16 0 8.832 7.157 16 16 16z"/></symbol><symbol id="sun" viewBox="0 0 32 32"><path fill="currentColor" d="M16 10c-3.306 0-6 2.694-6 6s2.694 6 6 6 6-2.694 6-6-2.694-6-6-6zm15.4 5.031l-5.919-2.956L27.575 5.8c.281-.85-.525-1.656-1.369-1.369l-6.275 2.094L16.969.6c-.4-.8-1.537-.8-1.938 0l-2.956 5.919-6.281-2.094c-.85-.281-1.656.525-1.369 1.369l2.094 6.275L.6 15.032c-.8.4-.8 1.538 0 1.938l5.919 2.956-2.094 6.281c-.281.85.525 1.656 1.369 1.369l6.275-2.094 2.956 5.919c.4.8 1.538.8 1.938 0l2.956-5.919 6.275 2.094c.85.281 1.656-.525 1.369-1.369l-2.094-6.275 5.919-2.956c.813-.406.813-1.544.012-1.944zm-9.744 6.625c-3.119 3.119-8.194 3.119-11.313 0s-3.119-8.194 0-11.313c3.119-3.119 8.194-3.119 11.313 0s3.119 8.194 0 11.313z"/></symbol></defs></svg>';
...
// EXTERNAL MODULE: ./node_modules/mini-css-extract-plugin/dist/loader.js??ruleSet[1].rules[2].use[1]!./node_modules/css-loader/dist/cjs.js!./src/styles.css
...
var update = injectStylesIntoStyleTag_default()((styles_default()), options);
       ...
       /* harmony default export */ const src_styles = ((styles_default()) && (styles_default()).locals ? (styles_default()).locals : undefined);

// EXTERNAL MODULE: ./src/templates/menu.handlebars
var menu_handlebars = __webpack_require__(756);
var menu_handlebars_default = /*#__PURE__*/__webpack_require__.n(menu_handlebars);
;// CONCATENATED MODULE: ./src/menu.json
...
;// CONCATENATED MODULE: ./src/refs.js
/* harmony default export */ const refs = ({
...
function init() {
  ...
  refs.ulRef.innerHTML = menu_handlebars_default()(menu_namespaceObject);
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return "  <li class='menu__item'>\n    <article class='card'>\n      <img src="
    ...
    + "\n        </p>\n\n        <ul class='tag-list'>\n"
    + ((stack1 = lookupProperty(helpers,"each").call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? lookupProperty(depth0,"ingredients") : depth0),{"name":"each","hash":{},"fn":container.program(2, data, 0),"inverse":container.noop,"data":data,"loc":{"start":{"line":18,"column":10},"end":{"line":20,"column":19}}})) != null ? stack1 : "")
